...
;
(function($) {
  var mqTest = Modernizr.mq('(min-width: 48em)');
  var $html = $('html');
  ...
  $('#js-menu-trigger').click(function(e){
    ...
    if (!$target.is(':visible'))
      $target.addClass('pure-menu pure-menu-open').fadeIn(100);
    else
      $target.fadeOut(100, function(){
        $(this).removeClass('pure-menu pure-menu-open');
      });
  });

  if (mqTest == true || $html.hasClass('ie8')) {
    $target.removeClass('pure-menu pure-menu-open').show(0);
    $('.level-0 > li', '.main-menu').on({
      hover: function(e){
        var $menus = $('ul.level-1', '.main-menu'),
            $hovers = $('.level-0 > li', '.main-menu'),
            $submenu = $(this).children('ul.level-1'),
            $current = $(this);
        ...
        if (!$submenu.is(':visible')) {
          ...
          $submenu.on({
            mouseenter: function(e){
              clearTimeout($current.data('delay'))
            },
          ...
          }).addClass('shown').fadeIn(100);
        } else if ($(e.target).is('[class*="header-bottom-"]')) {
          $menus.fadeOut(100)
          $hovers.removeClass('selected')
        }
      },
      mouseenter: function(e){
      ...
      mouseleave: function(e){
        var $submenu = $(this).children('ul.level-1'),
            $current = $(this),
