...
<div class="node-answers-wrapper">
  <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix" <?php print $attributes; ?>>
    ...
    <div class="answer-widgets">
      <?php
      if (isset($content['itc_thumbs_up_widget'])):
        print render($content['itc_thumbs_up_widget']);
      endif;
      ?>
      <?php
    ...
    <div class="answer-body">
      <div class="content clearfix" <?php print $content_attributes; ?>>
        ...
        hide($content['links']);
        hide($content['itc_thumbs_up_widget']);
...
<?php if (isset($content['answers_list'])): ?>
  <div class="answers-list pure-g pure-u-md-2-3">
    <?php print render($content['answers_list']); ?>
  </div>
<?php endif; ?>

<?php if (isset($content['new_answer_form'])): ?>
  <div class="new-answer-form pure-g pure-u-md-2-3">
